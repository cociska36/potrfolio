...
from bin.payments.crypto.crypto_params import check_db_crypto
...
def get_payment_keyboard():
    ...
    #if check_db_crypto():
    #    keyboard.add(types.InlineKeyboardButton(text=const_ru["crypto"],
    #                                            callback_data="payment=crypto"))

    keyboard.add(types.InlineKeyboardButton(text=const_ru["admin_payment"],
                                            callback_data="payment=admin"))
    return keyboard
